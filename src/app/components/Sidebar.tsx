...
import { LogOut, Microscope, School, User } from 'lucide-react';
    ...
    return (
        <aside className='sticky top-0 h-screen w-[240px] flex-col justify-between border-r'>
            <div className='h-[calc(100%-154px)]'>
                <div className='mt-8 px-4 gap-3 flex  items-center'>
                            ...
                            >
                                <li
                                    className={cn(
                                        ...
                                        isRouterPathnameMatched(link.link, pathname, link.exact) && 'bg-muted text-foreground'
                                    )}
                                >
