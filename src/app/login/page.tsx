        ...
        <>
            <div className='relative flex h-svh  items-center justify-center lg:px-0'>
                <div className='relative hidden h-full w-[400px] flex-shrink-0 flex-col bg-muted p-6 text-white dark:border-r lg:flex'>
                    ...
                    <div className='relative z-20 gap-4 flex flex-col justify-center h-full items-center text-lg font-medium'>
                        ...
                        />
                        <h1 className='font-semibold text-3xl text-center'>Comilla polytechnic institute</h1>
                    </div>
                </div>
